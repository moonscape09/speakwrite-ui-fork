...
export default function AddFileButton( { setFiles } ) {
    return (
        <button
            ...
            className="mt-2 w-fit bg-transparent cursor-pointer dark:text-white hover:bg-gray-300 dark:hover:bg-gray-700 text-black font-bold py-1 px-2 rounded-lg flex gap-2 hover:opacity-80 transition-colors duration-200 ease-in-out"
            >
            <FilePlus size={22}/>
        </button>
    );
